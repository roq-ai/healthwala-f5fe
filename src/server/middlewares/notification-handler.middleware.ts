...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'health_equipment.create': {
    roles: ['business-owner'],
    key: 'health-equipment-added',
    tenantPath: ['organization', 'user', 'health_equipment'],
    userPath: [],
  },
  'personal_trainer.create': {
    roles: ['business-owner'],
    key: 'personal-trainer-added',
    tenantPath: ['organization', 'user', 'personal_trainer'],
    userPath: [],
  },
  'dietician.create': {
    roles: ['business-owner'],
    key: 'dietician-added',
    tenantPath: ['organization', 'user', 'dietician'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'health-equipment-supplier', 'personal-trainer', 'dietician'];
