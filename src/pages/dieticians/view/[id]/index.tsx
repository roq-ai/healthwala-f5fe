...
import { getDieticianById } from 'apiSdk/dieticians';
import { DieticianInterface } from 'interfaces/dietician';

function DieticianViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('dietician', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/dieticians/edit/${id}`} passHref legacyBehavior>
                    <Button
