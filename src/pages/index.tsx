...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`HealthWala`}</title>

        <meta
          name="description"
          content="Unlock a healthier lifestyle with HealthWala - Your online gateway to health equipment, expert trainers, and nutritious food."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1476480862126-209bfaa8edc8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxoZWFsdGglMjBlcXVpcG1lbnR8ZW58MHx8fHwxNjkzNTAxOTM4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock a healthier lifestyle with HealthWala - Your online gateway to health equipment, expert trainers, and nutritious food.`}
            </Text>
            <Box
